...
function nova_get_theme_menus() {
	$menus = array(
		'nova_topbar_menu' 		=> esc_html__('Top Bar (Mobile)', 'trikon'),
		'nova_menu_primary' 		=> esc_html__('Main Navigation', 'trikon'),
		'nova_menu_fullscreen' 		=> esc_html__('Fullcreen Menu', 'trikon'),
