...
Kirki::add_panel( 'panel_styles', array(
    'title'         => esc_html__( 'Styles', 'trikon' ),
    'priority'      => 40,
) );
...
Kirki::add_section( 'style_callout', array(
    'title'          => esc_html__( 'Callout', 'trikon' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_topbar', array(
    'title'          => esc_html__( 'Topbar', 'trikon' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_main_menu', array(
    'title'          => esc_html__( 'Main Menu', 'trikon' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_dropdowns', array(
    'title'          => esc_html__( 'Dropdown', 'trikon' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_quick_view', array(
    'title'          => esc_html__( 'Quick View', 'trikon' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
