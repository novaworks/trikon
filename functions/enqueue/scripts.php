...
function nova_scripts() {
	...
	$nova_js_vars = array(
		...
		'select_placeholder'        => esc_html__( 'Choose an option', 'trikon' ),
		'blog_pagination_type' 			=> Nova_OP::getOption('blog_pagination'),
		'load_more_btn'        			=> esc_html__( 'Load more', 'trikon' ),
		'read_more_btn'        			=> esc_html__( 'Read more', 'trikon' ),
		'read_less_btn'        			=> esc_html__( 'Read less', 'trikon' ),
