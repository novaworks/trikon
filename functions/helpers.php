        ...
        if(has_post_thumbnail()){ ?>
            <div class="post-thumbnail">
							...
							if( 'video' == get_post_format() && NOVA_RWMB_IS_ACTIVE  ){
									$popup_video_link = rwmb_meta('trikon_post_video_url');
									$id = rand();
...
//==============================================================================
if ( ! function_exists( 'trikon_excerpt' ) ) {

	function trikon_excerpt( $length = 30 ) {
		global $post;
...
if ( ! function_exists( 'nova_post_time_ago' ) ) {
	function nova_post_time_ago( $type = 'post' ) {
	    ...
	    return human_time_diff($d('U'), current_time('timestamp')) . " " . esc_html__('ago','trikon');
