...
add_action( 'trikon/action/wc_product_title', 'woocommerce_template_single_title',5 );

//Product Rating & Price
remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_rating',10 );
remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_price',10 );
add_action( 'trikon/action/wc_price_rating', 'woocommerce_template_single_price',5 );
add_action( 'trikon/action/wc_price_rating', 'woocommerce_template_single_rating',10 );
...
$page_header_images = rwmb_meta( 'trikon_product_page_header_image', array( 'limit' => 1 ) );
}
$page_header_image = reset( $page_header_images );
if(! $page_header_image) {
	add_action('trikon/action/wc_product_title', 'nova_site_breadcrumb', 0);
}
		...
		<div class="grid-x">
			...
			<div class="cell small-12 large-5">
				<div class="summary entry-summary">
					<?php do_action( 'trikon/action/wc_product_title' ); ?>
					<div class="nova-custom__price-rating-box">
						<?php do_action( 'trikon/action/wc_price_rating' ); ?>
					</div>
